                ...
                <>
                    ...
                    <div className='d-flex flex-wrap my-3 text-capitalize'>
                        ...
                        <p className='info1 my-2'>
                            <span className='me-1'><Location icon={faLocationDot} className='fa-2xl' /> location :</span>
                        ...
                        <p className='info1 my-2'>
                            <span className='me-1'><Mony icon={faDollarSign} className='fa-2xl' /> paid :</span>
                            <span className='data1'>{item.paid.amount} sdg / H</span>
                        </p>

                        <p className='info1 my-2'>
                            <span className='me-1'><Time icon={faClock} className='fa-2xl' /> duration :</span>
                    ...
                    <div className=''>
                        ...
                        <div className="Left-Request-Top-left-parags-1 py-2">
                            <h6 className="py-1 blue-color">
                                I'm looking for help with
                            </h6>
                            <ul>
                                <li>
                                    {item.helpWith.map((q, i) => <li key={i}>{q}</li>)}                                </li>
                            </ul>
                        </div>
                        <div>
                        ...
                        <div className="Left-Request-Top-left-parags-3 py-2">
                            ...
                            <ul>
                                <li>
                                    {item.haveBgWith.map((q, i) => <li key={i}>{q}</li>)}
                                </li>
                            </ul>
                        </div>
                        {/* <div>
